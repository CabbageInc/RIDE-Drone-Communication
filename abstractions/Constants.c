...
const uint16_t DEFAULT_RX_LENGTH = 218; // default RX packet length = 218 Bytes
...
const uint64_t DEFAULT_SRC_ADDR = 0x000000000000FFFF; // default source address = 0x000000000000FFFF (broadcast address)
...
const uint8_t RECEIVE_OPTIONS = 0xC1; // default receive options for RX frames
